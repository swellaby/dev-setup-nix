...
source "${BATS_TEST_DIRNAME}/../../../../${BROWSERS_DEVELOPMENT_DIRECTORY_PATH_FROM_ROOT}/firefox/firefox.sh"

load "../../../../${BATS_SUPPORT_LOAD_PATH_FROM_ROOT}"
load "../../../../${BATS_ASSERT_LOAD_PATH_FROM_ROOT}"

readonly TEST_SUITE_PREFIX="${BROWSERS_DEVELOPMENT_SUITE_PREFIX}::firefox::install_firefox::"
