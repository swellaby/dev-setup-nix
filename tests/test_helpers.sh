...
declare -xr APPLICATIONS_BROWSER_DIRECTORY_PATH_FROM_ROOT="${APPLICATIONS_DIRECTORY_PATH_FROM_ROOT}/browser"
declare -xr APPLICATIONS_CLOUD_DIRECTORY_PATH_FROM_ROOT="${APPLICATIONS_DIRECTORY_PATH_FROM_ROOT}/cloud"
...
declare -xr APPLICATIONS_NOTE_DIRECTORY_PATH_FROM_ROOT="${APPLICATIONS_DIRECTORY_PATH_FROM_ROOT}/note"
...
declare -xr APPLICATIONS_BROWSER_SUITE_PREFIX="${APPLICATIONS_SUITE_PREFIX}::browser"
declare -xr APPLICATIONS_CLOUD_SUITE_PREFIX="${APPLICATIONS_SUITE_PREFIX}::cloud"
...
declare -xr APPLICATIONS_NOTE_SUITE_PREFIX="${APPLICATIONS_SUITE_PREFIX}::note"
