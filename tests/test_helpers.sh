...
declare -xr APPLICATIONS_CHAT_DIRECTORY_PATH_FROM_ROOT="${APPLICATIONS_DIRECTORY_PATH_FROM_ROOT}/chat"
...
declare -xr APPLICATIONS_CHAT_SUITE_PREFIX="${APPLICATIONS_SUITE_PREFIX}::chat"
